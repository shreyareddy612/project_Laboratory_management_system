...
const StaffRegister = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await http.post('/staff/registerStaff', formData);
    ...
    return (
        <div className='flex flex-col justify-center items-center h-4/5 bg-teal-50'>
            <form className="flex flex-col items-center rounded-lg shadow-md p-2 w-full sm:w-2/3 md:w-1/2 lg:w-1/3">
                ...
                <input className="border-b-2 border-gray-400 w-4/5 p-2 mb-4 focus:outline-none focus:border-green-700" type="text" placeholder="Full Name" name='full_name' onChange={handleFormChange}/>
